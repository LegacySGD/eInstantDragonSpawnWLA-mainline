...
public class DragonSpawnWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DragonSpawnWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DragonSpawnWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DragonSpawnWLAIW/InitOutcome.xml").getDocumentElement();
